...
public class PermissionRequest {
    ...
    public PermissionRequest(ArrayList<String> permissions, PermissionManager.PermissionCallback permissionCallback) {
    ...
    public PermissionManager.PermissionCallback getPermissionCallback() {
